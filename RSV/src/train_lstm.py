...
class LitModel(pl.LightningModule):
    def __init__(self, args, disease_tensor_emb):
        ...
        self.model = LSTM(hidden=32, test_length=args.test_length)
...
def supervised(args):
    ...
    version = f"LSTM-{args.val_start}-{args.test_start}-len-{args.test_length}-{version_id}"
    ...
    # dump
    with open("../logs/results/lstm.log", "a") as f:
